...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Tracker, App1", Tracker.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == Tracker.class) {
			mono.android.TypeManager.Activate ("App1.Tracker, App1", "", this, new java.lang.Object[] {  });
		}
	}


	public Tracker (int p0)
	{
		super (p0);
		if (getClass () == Tracker.class) {
			mono.android.TypeManager.Activate ("App1.Tracker, App1", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
		}
	}
