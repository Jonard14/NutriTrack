...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.DietDisplay, App1", DietDisplay.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == DietDisplay.class) {
			mono.android.TypeManager.Activate ("App1.DietDisplay, App1", "", this, new java.lang.Object[] {  });
		}
	}


	public DietDisplay (int p0)
	{
		super (p0);
		if (getClass () == DietDisplay.class) {
			mono.android.TypeManager.Activate ("App1.DietDisplay, App1", "System.Int32, mscorlib", this, new java.lang.Object[] { p0 });
		}
	}
