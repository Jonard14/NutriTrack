...
namespace App1
{
    [Activity(Label = "Edit & Delete Food", ScreenOrientation = ScreenOrientation.Portrait)]
    public class Admin_EditDelFoodList : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.admin_editdelfoodlist_drawer);
        ...
        private void lv_ItemClick(object sender, AdapterView.ItemClickEventArgs e)
        {
            ...
            Intent i = new Intent(this, typeof(Admin_DisplayFood));
